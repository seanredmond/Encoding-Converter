package Unicode::Encoding::ISO_8859_5;
...
sub _initialize {
    my $self = shift;
    $self->{NAME}     = 'ISO-8859-5/Latin-Cyrillic/ECMA-113';
    $self->{UNICODE}  = \%uni;
    $self->{DECODE}   = \%decode;
    $self->{LANGUAGE} = 'Bulgarian/Bielorussian/English/Macedonian/Russian/Serbo-Croatian/Ukrainian';
    $self->{HTML_ENC} = 'iso-8859-5';
}
